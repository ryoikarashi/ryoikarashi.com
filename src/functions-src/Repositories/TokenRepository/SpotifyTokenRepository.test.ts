...
describe('Test GooglePhotosRepository', () => {
    ...
    describe('getTokenByAuthorizationCode', () => {
        it('it has been called with appropriate params', async () => {
            const repository = new SpotifyTokenRepository(admin.initializeApp().firestore(), collectionName, docPath);
        ...
        it('throws an exception', async () => {
            ...
            const repository = new SpotifyTokenRepository(db, collectionName, docPath);
