...
export class TokenService implements ITokenService {
    ...
    constructor(http: AxiosStatic, tokenRepo: ITokenRepository, config: IOAuthConfig) {
        this._http = http;
    ...
    public async refreshAccessToken(): Promise<AccessToken> {
        ...
        const refreshedToken = await this._tokenRepo.refreshToken(this._http, token, this._config);
